...
class OrdinalReferenceParser:
    ...
    ORDINAL_PATTERNS = {
        'zh': [
            # "第三部分" / "第三章" / "第三节"
            (r'第([一二三四五六七八九十百两]+)[部章节篇]', 'chinese_num'),
            # "一、" / "二、" / "1." / "2."
            (r'(?:^|[^\d])([一二三四五六七八九十两]+)[、．.]', 'chinese_num'),
            # "第一个" / "第二个"
            (r'第([一二三四五六七八九十两\d]+)个', 'mixed_num'),
            # "前两个" / "后三个" / "前三章"
            (r'前([一二三四五六七八九十两\d]+)[个章节]', 'chinese_num'),
            (r'后([一二三四五六七八九十两\d]+)[个章节]', 'chinese_num'),
            # "最后两个" / "最后三章"
            (r'最后([一二三四五六七八九十两\d]+)[个章节]', 'chinese_num'),
        ],
        'en': [
